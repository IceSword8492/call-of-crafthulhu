...
execute as @a[scores={hasClickItem=1,clicked=1..}] at @s run particle minecraft:smoke ~ ~-.5 ~ 1 1 1 1.0 100
...
# 黒い束縛 lv.1
# 普通のゾンビを創造することができる。
execute as @a[scores={hasClickItem=1,clicked=1..}] at @s run particle minecraft:enchant ~ ~-.5 ~ 1 1 1 1.0 100
...
execute as @a[scores={hasClickItem=3,clicked=1..}] at @s run particle minecraft:crit ~ ~-.5 ~ 1 1 1 1.0 100
...
execute as @a[scores={hasClickItem=4,clicked=1..}] at @s run effect give @s minecraft:hunger 1 255
